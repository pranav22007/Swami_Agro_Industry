...
export const translations: Translations = {
  ...
  mr: {
    ...
    saleDeleted: 'विक्री यशस्वीरित्या हटविली',
    deleteConfirmTitle: 'हटवण्याची पुष्टी करा',
    deleteConfirmMsg: 'तुम्हाला खात्री आहे की तुम्ही हे रेकॉर्ड हटवू इच्छिता?',
    exportSales: 'विक्री निर्यात करा (CSV)',
    exportCustomers: 'ग्राहक निर्यात करा (CSV)',
  },
};
